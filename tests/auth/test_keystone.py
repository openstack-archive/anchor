...
class AuthKeystoneTests(unittest.TestCase):
    ...
    def test_auth_login(self):
        ...
        with mock.patch.dict(config, data):
            ...
            expected = AuthDetails(username=user, groups=roles)
            ...
            with requests_mock.mock() as m:
                ...
                self.assertEqual(keystone.login(keystone_token), expected)
                ...
                self.assertEqual(keystone.login(keystone_token), AUTH_FAILED)
