...
def create_timezone(minute_offset):
    """Create a new timezone with a specified offset. Since tzinfo is just a
    base class, and tzinfo subclasses need a no-arguments __init__(), we need
    to generate a new class dynamically.

    :param minute_offset: total timezone offset in minutes
    """  # flake8: noqa (random flake failure)
