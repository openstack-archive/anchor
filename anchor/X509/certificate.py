...
class X509Certificate(object):
    ...
    def set_not_before(self, t):
        ...
        # TODO(stan) fix type after cryptography >0.9 is released openssl
        # actually takes ASN1_TIME*, which may be the generalized type too
        asn1_time = self._ffi.cast("ASN1_UTCTIME*", asn1_time)
        ret = self._lib.X509_set_notBefore(self._certObj, asn1_time)
        self._lib.ASN1_UTCTIME_free(asn1_time)
        if ret == 0:
            raise X509CertificateError("Could not set X509 certificate "
    ...
    def get_not_before(self):
        ...
        not_before = self._ffi.cast("ASN1_TIME*", not_before)
    ...
    def get_not_after(self):
        ...
        not_after = self._ffi.cast("ASN1_TIME*", not_after)
