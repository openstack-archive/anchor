...
#Some logging is better than broken logging.
...
def _run_validator(validator_step, pecan_args):
    ...
    """
    #TODO: Add some validation checks (though the config validator should have already done this)
    ...
    if not hasattr(validators, function_name):
        logger.error("_run_validator: no validator method {}".format(validator_step))
        return False
