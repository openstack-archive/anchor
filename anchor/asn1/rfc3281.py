...
ObjectDigestInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('digestAlgorithm', rfc2459.AlgorithmIdentifier()),
...
IssuerSerial.componentType = namedtype.NamedTypes(
    namedtype.NamedType('issuer', rfc2459.GeneralNames()),
    namedtype.NamedType('serial', rfc2459.CertificateSerialNumber()),
    namedtype.OptionalNamedType('issuerUID', rfc2459.UniqueIdentifier())
)
...
TargetCert.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType('targetName', rfc2459.GeneralName()),
...
Target.componentType = namedtype.NamedTypes(
    namedtype.NamedType('targetName', rfc2459.GeneralName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))),
    namedtype.NamedType('targetGroup', rfc2459.GeneralName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
...
id_at_role = _OID(rfc2459.id_at, 72)


id_pe_aaControls = _OID(rfc2459.id_pe, 6)


id_at_role = _OID(rfc2459.id_at, 72)


id_ce_targetInformation = _OID(rfc2459.id_ce, 55)


id_pe_ac_auditIdentity = _OID(rfc2459.id_pe, 4)
...
id_aca = _OID(rfc2459.id_pkix, 10)
...
V2Form.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType('issuerName', rfc2459.GeneralNames()),
...
AttCertIssuer.componentType = namedtype.NamedTypes(
    namedtype.NamedType('v1Form', rfc2459.GeneralNames()),
...
Holder.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType('baseCertificateID', IssuerSerial().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))),
    namedtype.OptionalNamedType('entityName', rfc2459.GeneralNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
...
AttributeCertificateInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('attributes', univ.SequenceOf(componentType=rfc2459.Attribute())),
    namedtype.OptionalNamedType('issuerUniqueID', rfc2459.UniqueIdentifier()),
    namedtype.OptionalNamedType('extensions', rfc2459.Extensions())
)
...
RoleSyntax.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType('roleAuthority', rfc2459.GeneralNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))),
    namedtype.NamedType('roleName', rfc2459.GeneralName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)))
)
...
ACClearAttrs.componentType = namedtype.NamedTypes(
    namedtype.NamedType('acIssuer', rfc2459.GeneralName()),
    namedtype.NamedType('acSerial', univ.Integer()),
    namedtype.NamedType('attrs', univ.SequenceOf(componentType=rfc2459.Attribute()))
)
...
id_pe_ac_proxying = _OID(rfc2459.id_pe, 10)
...
SvceAuthInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType('service', rfc2459.GeneralName()),
    namedtype.NamedType('ident', rfc2459.GeneralName()),
...
IetfAttrSyntax.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType('policyAuthority', rfc2459.GeneralNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))),
